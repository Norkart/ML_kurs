...
exports.copyPackageToStore = function (pkg, options) { return __awaiter(_this, void 0, void 0, function () {
    var workingDir, ignoreRule, ingnoreFilesIncludedByDefaultRule, ignores, includeFoldersRule, explicitIncludeRule, includes, isIncluded, copyFromDir, locPackageStoreDir, filesToCopy, hashes, signature, shortSignature, ensureSymlinkSync_1, pkg_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                ingnoreFilesIncludedByDefaultRule = ignore();
